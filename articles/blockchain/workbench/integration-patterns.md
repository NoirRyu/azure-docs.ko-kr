...
외부 시스템 또는 장치가 REST 또는 메시지 API를 사용하여 스마트 컨트랙트과 쉽게 상호 작용할 수 있게 하려면 다음을 수행해야 합니다.
